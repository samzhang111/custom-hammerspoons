...
local units = {
  ...
  quad1        = { x = 0.00, y = 0.00, w = 0.25, h = 1.00 },
  quad2        = { x = 0.25, y = 0.00, w = 0.25, h = 1.00 },
  quad3        = { x = 0.50, y = 0.00, w = 0.25, h = 1.00 },
  quad4        = { x = 0.75, y = 0.00, w = 0.25, h = 1.00 },
...
function obj:quad1() move(units.quad1, nil, true, 0) end
function obj:quad2() move(units.quad2, nil, true, 0) end
function obj:quad3() move(units.quad3, nil, true, 0) end
function obj:quad4() move(units.quad4, nil, true, 0) end
...
function obj:bindHotkeys(mapping)
  ...
  hs.hotkey.bind(self.mapping.quad1[1], self.mapping.quad1[2], function() self:quad1() end)
  hs.hotkey.bind(self.mapping.quad2[1], self.mapping.quad2[2], function() self:quad2() end)
  hs.hotkey.bind(self.mapping.quad3[1], self.mapping.quad3[2], function() self:quad3() end)
  hs.hotkey.bind(self.mapping.quad4[1], self.mapping.quad4[2], function() self:quad4() end)
